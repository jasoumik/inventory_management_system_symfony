 ...
 */
final class Version20210406042226 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE audit_log (id INT NOT NULL, type_id VARCHAR(200) NOT NULL, type VARCHAR(200) DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, event_time TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, "user" VARCHAR(255) NOT NULL, impersonatingUser VARCHAR(255) DEFAULT NULL, ip VARCHAR(20) DEFAULT NULL, PRIMARY KEY(id))');
